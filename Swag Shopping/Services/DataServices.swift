...
class DataService{
    ...
    private let hoodies = [
        Product(title: "Devslops Logo Hoodie Grey", price: "$32", imageName: "hoodie01.png"),
        Product(title: "Devslops Logo Hoodie Red", price: "$32", imageName: "hoodie02.png"),
        Product(title: "Devslops Hoodie Grey", price: "$32", imageName: "hoodie03.png"),
    ...
    private let shirts = [
        ...
        Product(title: "Devslops Badge Shirt Light Grey", price: "$19", imageName: "shirt02.png"),
